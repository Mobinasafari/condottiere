...
class control{
	...
	void ostan_initializer()
	{
		...
		vector_of_ostans[4].set_name("BORGE");
		vector_of_ostans[5].set_name("MORINA");
		vector_of_ostans[6].set_name("ARMENTO");
		vector_of_ostans[7].set_name("LIA");
		vector_of_ostans[8].set_name("OLIVADI");
		vector_of_ostans[9].set_name("DIMASE");
		vector_of_ostans[10].set_name("ATELA");
		vector_of_ostans[11].set_name("ENNA");
		vector_of_ostans[12].set_name("BELLA");
		vector_of_ostans[13].set_name("CALINE");
	}
