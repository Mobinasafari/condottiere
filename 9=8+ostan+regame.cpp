...
class control{
	...
	public :
		void start_game( int number_of_players)
		{
			...
			while ( end_of_game == 0 )
			{
				start_game1( number_of_players);
	        	cout << "*********************  next rand  ************************ ";
	        	recavery(number_of_players);
			}     
		}
	...
	int who_is_starter( int number_of_players )
	{
		...
		cout << endl << "starter : "<< starter ;
		return starter;
	}
	
	
	void start_game1( int number_of_players)
	{
		bool pass = 0 ;
		bool have_card = 0 ;
	...
	void one_door_game( /*int who_is_starter ,*/ int number_of_players )
	{
		for ( int i = 0 ; i < number_of_players ; i++ )
		{
			if ( playerArry[i].get_pass() == 0 )
			...
			{
				cout << endl << "player " << i+1 << " you have passed " << endl ;
			}
		}	
	}
	...
	void play_card( int playerr )
	{
		...
		cout << endl << "player " << playerr + 1 << "your cards are : " << endl ;
		...
		if ( playerArry[playerr].get_pass() == 1 )
		{
			...
			cout << endl << "choise your card to play : "<< endl ;
			cin >> card_name ;
		}
	...
	void recavery(int number_of_players)
	{
		for ( int i = 0 ; i < number_of_players ; i++)
		{
