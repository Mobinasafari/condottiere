	...
	void play_card( int playerr , int number_of_players )
	{
		...
		if ( playerArry[playerr].get_pass() == 1 )
		{
			...
			while ( test == false)
			{
				...
				if ( card_name == "pass" ||card_name == "1" || card_name == "2"  || card_name == "3" || card_name == "4" || card_name == "5" || card_name == "6" || card_name == "10"|| card_name == "matarsak"|| card_name == "tablzan"|| card_name == "bahar"|| card_name == "zemestan" || card_name == "shahdokht" || card_name =="rishsefid" || card_name == "parchamdar" || card_name == "shirzan")          //khataaaaaaaaaaaaaaaa
				{
					test = true ;
				}
			}
