...
class player{
	...
	public :
		...
		{
			//cout << "88888888888888888888888888888";
			Arry_of_hand_card[andis] = my_card ;
			//cout << my_card -> get_name();
			//print_card();
		}
		...
		void print_all_hand_cards( int andis , bool saving ) //save : prototaype 
		{
			...
			else //save 
			{
				...
				my_file1 << endl << "number_of_cards_player " << andis+1 << "  " << number_of_card - number_of_played_card << endl;
...
class control{
	...
	void start_game( int number_of_players)
	{
		if ( statusss == 1 ) //continue
		{
			...
			//cout << endl << "ostan_initializer is starting : " << endl ;
			ostan_initializer();
			//cout << endl << "ostan_initializer is ending : " << endl ;
			//cout << endl << "number_of_players before file mmmmmmmmmmmmmmmmmm" << number_of_players << endl ;
			//cout << endl << "reading file is starting : " << endl ;
			number_of_players = reading_file();
			//cout << endl << "reading file is endig : " << endl ;
			//cout << endl << "number_of_players after file mmmmmmmmmmmmmmmmmmmmmmm" << number_of_players << endl ;
		
			//cout << endl << "who is stater is starting  : " << endl ;
			who_is_starter( number_of_players );
			//cout << endl << "who is stater is ending  : " << endl ;
	...
	int reading_file()
	{
		...
		for ( int i = 0 ; i <  10 ; i++)                                        //khataaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
		{
			...
			if ( input == "number_of_cards_player ")
			{
				cout << "222222222222222222222222222";
				int andis;
				my_file >> num ;
				andis = num ;
				my_file >> num ;
	...
	int start_game1( int number_of_players)
	{
		...
		while ( pass == 0 && have_card == 0 )
		{
			...
			for ( int i = 0 ; i < number_of_players ; i++)
			{
				...
				{
					cout << endl << "playerArry[i].get_number_of_card()" << playerArry[i].get_number_of_card() << endl ; //mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm
					cout << endl << "playerArry[i].get_number_of_played_card()" << playerArry[i].get_number_of_played_card() << endl ;
					counter_of_players_that_dont_have_card++ ;
				}	
			}
			
			cout << endl << "counter_of_players_that_dont_have_card" << counter_of_players_that_dont_have_card << endl ;
			if (counter_of_players_that_dont_have_card == number_of_players - 1 )
			{
				cout << "number_of_players" << number_of_players;
				cout << endl << "forrrrrrrrrrr" << endl ;
				have_card = 1 ;
			}
			else
			{
			...
			cout <<endl<< "have_card" << have_card << endl ;
